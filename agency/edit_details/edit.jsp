...
min_date.setFullYear(2014,11,30);
var max_date=new Date();
max_date.setFullYear(2015,06,01);
...
if( date1<min_date || date2>max_date)
{
  ...
  message+="Placement season will start from December-2014 upto June-2015.\n";
}
  ...
  <aside>
	...
	%>
      <form name="form_company_profile" id="form_company_profile" method="post" onSubmit="return validate_empty();">
        <table width="100%" align="center" class="aa" border="1">
          <tr>
            <td>
                <h2>General Info </h2>
                
                <p>&nbsp;</p>
<table width="100%" align="center" class="aa" style="width:100%;" border="1">
                    <tr>
                      <td width="30%" style="text-align: right">*Name of the Organization&nbsp;</td>
                    ...
                    <tr>
                      ...
                      <td style="text-align: left"><label for="company_address"></label>
                        ...
                        <textarea name="company_address" id="company_address" cols="45" rows="5" onKeyPress="return alpha(event);" ><%=company_address%></textarea>
                    ...
                    <tr>
                      ...
                      <td style="text-align: left"><label for="company_website"></label>
                        <span id="sprytextfield1">
                        <input name="company_website" type="text" id="company_website" size="60" value="<%=company_website%>" onKeyPress="return alpha(event);">
                      <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                    </tr>
                    <tr>
                      <td style="text-align: right">*Brief Write up on the Organization</td>
                      <td style="text-align: left"><label for="company_about"></label>
                        <span id="sprytextarea2">
                        <textarea name="company_about" type="text" id="company_about" cols="45" rows="5"  onKeyPress="return alpha(event);"><%=company_about%>
</textarea>
                      <span class="textareaRequiredMsg">A value is required.</span></span></td>
                    </tr>
              </table>
          <p>&nbsp;</p>
                  <table width="600" border="1" align="center" class="aa">
                    <tr>
                    ...
                    <tr  style="text-align: left">
                      <td height="194"><table width="100%" border="1" align="left" class="aa">
                        <tr>
                          <td width="50%"><input name="category" type="radio" id="category_2" value="Private" <% if(category.equals("Private"))out.println("checked"); %> onClick="return enabletxt();">
                            <strong>Private</strong></td>
                          <td width="50%"><input type="radio" name="category" value="MNC(Indian Origin)" id="category_5" <% if(category.equals("MNC(Indian Origin)"))out.println("checked"); %> onClick="return enabletxt();">
                      ...
                      <td><p><br>
                        ...
                        <table width="100%" border="1" align="left" class="aa" style="text-align:left;">
                          <tr>
                            <td width="40%"><label>
                          ...
                          <tr>
                            <td><label>
                              ...
                              Consulting</label></td>
                            <td><label>
                              <input type="radio" name="sector" value="RandD" id="sector_8" <% if(sector.equals("RandD"))out.println("checked"); %> onClick="return enabletxt2();" >
                              R&D</label></td>
                          </tr>
                          <tr>
                            <td><label>
                              <input type="radio" name="sector" value="Oil and Gas" id="sector_9" <% if(sector.equals("Oil and Gas"))out.println("checked"); %> onClick="return enabletxt2();" >
                              Oil and Gas</label></td>
                            <td><label>
                              <input type="radio" name="sector" value="E-Commerce" id="sector_10" <% if(sector.equals("E-Commerce"))out.println("checked"); %> onClick="return enabletxt2();" >
                              E-Commerce</label></td>
                          </tr>
                          <tr>
                            <td><label>
                              <input type="radio" name="sector" value="FMCG" id="sector_11" <% if(sector.equals("FMCG"))out.println("checked"); %> onClick="return enabletxt2();" >
                              FMCG</label></td>
                            <td><label>
                              <input type="radio" name="sector" value="Manufacturing" id="sector_12" <% if(sector.equals("Manufacturing"))out.println("checked"); %> onClick="return enabletxt2();" >
                              Manufacturing</label></td>
                          </tr>
                          <tr>
                            <td><label>
                              <input type="radio" name="sector" value="Telecommunications" id="sector_13" <% if(sector.equals("Telecommunications"))out.println("checked"); %> onClick="return enabletxt2();" >
                              Telecomm.</label></td>
                            <td><p>&nbsp;</p></td>
                          </tr>
                        </table>
                        <p><strong>
                          <input type="radio" name="sector" value="other" id="sector_7" <% if(!(sector.equals("Consulting")||sector.equals("RandD")||sector.equals("Oil and Gas")||sector.equals("E-Commerce")||sector.equals("FMCG")||sector.equals("Manufacturing")||sector.equals("Education")||sector.equals("Telecommunications")||sector.equals("Finance")||sector.equals("Management")||sector.equals("IT")||sector.equals("Analytics")||sector.equals("Core Engg.")))out.println("checked"); %>  onClick="return enabletxt2();">
                          Other:</strong>
                          <label for="sector_other"></label>
                          <input type="text" name="sector_other" id="sector_other" <% if(!(sector.equals("Consulting")||sector.equals("RandD")||sector.equals("Oil and Gas")||sector.equals("E-Commerce")||sector.equals("FMCG")||sector.equals("Manufacturing")||sector.equals("Telecommunications")||sector.equals("Education")||sector.equals("Finance")||sector.equals("Management")||sector.equals("IT")||sector.equals("Analytics")||sector.equals("Core Engg."))){out.println("value='"+sector+"'");}else{out.println(" disabled ");} %> onkeypress="return alpha(event);" >
                          <br>
                        </p></td>
                    </tr>
                  </table>
                  ...
                  <table width="100%" border="1" align="center">
                    <tr>
                      <td><table width="100%" align="left">
                        <tr>
                          <td><strong class="aa">Contact Details:</strong></td>
                        </tr>
                      </table></td>
                    </tr>
                    <tr>
                      <td><table width="100%" border="1" align="right" class="aa">
                        <tr>
                          <td width="20%">&nbsp;</td>
                          <td width="30%"><strong>Head HR</strong></td>
                          <td width="30%"><strong>*First Contact Person</strong></td>
                          <td width="30%"><strong>Second Contact Person</strong></td>
                        </tr>
                        <tr>
                          <td><strong>Name:</strong></td>
                          <td><label for="head_hr_name"></label>
                            <span id="sprytextfield7">
                            <input type="text" name="head_hr_name" id="head_hr_name" value="<%=head_hr_name%>" onKeyPress="return alpha(event);">
</span></td>
                          <td><label for="fcp_name"></label>
                            <span id="sprytextfield3">
                            <input type="text" name="fcp_name" id="fcp_name" value="<%=fcp_name%>" onKeyPress="return alpha(event);">
                          <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                          <td><label for="scp_name"></label>
                            <span id="sprytextfield11">
                            <input type="text" name="scp_name" id="scp_name" value="<%=scp_name%>" onKeyPress="return alpha(event);">
</span></td>
                        </tr>
                        <tr>
                          ...
                          <td><label for="head_hr_designation"></label>
                            ...
                            <input type="text" name="head_hr_designation" id="head_hr_designation" value="<%=head_hr_designation%>" onKeyPress="return alpha(event);">
</span></td>
                          <td><label for="fcp_designation"></label>
                            <span id="sprytextfield4">
                            <input type="text" name="fcp_designation" id="fcp_designation" value="<%=fcp_designation%>" onKeyPress="return alpha(event);">
                          <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                          <td><label for="scp_designation"></label>
                            <span id="sprytextfield12">
                            <input type="text" name="scp_designation" id="scp_designation" value="<%=scp_designation%>" onKeyPress="return alpha(event);">
</span></td>
                        </tr>
                        <tr>
                          ...
                          <td><label for="head_hr_email"></label>
                            ...
                            <input type="text" name="head_hr_email" id="head_hr_email" value="<%=head_hr_email%>" onKeyPress="return alpha(event);">
                          <span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
                          <td><label for="fcp_email"></label>
                            <span id="sprytextfield5">
                            <input type="text" name="fcp_email" id="fcp_email" value="<%=fcp_email%>" onKeyPress="return alpha(event);">
                          <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
                          <td><label for="scp_email"></label>
                            <span id="sprytextfield13">
                            <input type="text" name="scp_email" id="scp_email" value="<%=scp_email%>" onKeyPress="return alpha(event);">
                          <span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
                        </tr>
                        <tr>
                          ...
                          <td><label for="head_hr_mobile"></label>
                            ...
                            <input type="text" name="head_hr_mobile" id="head_hr_mobile" value="<%=head_hr_mobile%>" onKeyPress="return alpha(event);" >
                          <span class="textfieldMinCharsMsg">Minimum number of characters not met.</span><span class="textfieldMaxCharsMsg">Exceeded maximum number of characters.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
                          <td><label for="fcp_mobile"></label>
                            <span id="sprytextfield6">
                            <input type="text" name="fcp_mobile" id="fcp_mobile" value="<%=fcp_mobile%>" onKeyPress="return alpha(event);">
                          <span class="textfieldRequiredMsg">A value is required.</span><span class="textfieldInvalidFormatMsg">Invalid format.</span></span></td>
                          <td><label for="scp_mobile"></label>
                            <span id="sprytextfield14">
                            <input type="text" name="scp_mobile" id="scp_mobile" value="<%=scp_mobile%>" onKeyPress="return alpha(event);">
...
<h2>Selection Procedure              </h2>
                <p>&nbsp;</p>                  
<table width="640" border="1" align="left" cellpadding="5" cellspacing="5" class="aa">
                  
                    <tr>
                      <td width="30%"border="0.5"align="right">*Preferred period of visit for recruitment</td>
                      <td width="70%" border="0.5" align="left">
                    ...
                    <tr>
                      <td>*Written Test (Technical/Aptitude)
...
<%
				...
				out.println("<table width='100%' border='1' cellspacing='5' cellpadding='5'>");
				  out.println("<tr>");
				    //out.println("<th width='5%'>S.No</th>");
				    out.println("<th width='50%'>Approved Profiles</th>");
				    out.println("<th width='50%'>Temporary Profiles</th>");
				    out.println("</tr>");
				 ...
				 // ResultSet temp=db.execSQL("select package_name from package_details_temp where agency_id="+agency_id);
				  ...
				  out.println("<br><a href=\"vacancy_appr.jsp?id="+appr.getInt("package_id")+"\">"+approved_package+"</a><br>");
				  ...
				  appr.close();
					...
					{
						out.println("<br/><a href=\"vacancy_temp.jsp?id="+temp.getInt("package_id")+"\">"+temp.getString(1)+"</a><br>");
					}
					temp.close();
 					out.println("</td></tr>");
					db.close();
 ...
 %>                
        ...
        <table align="center"><tr><td><p><br>
        <input type="submit" name="submit" id="submit" value="Submit"></p></td></tr></table>
...
<script type="text/javascript">
var sprytextarea1 = new Spry.Widget.ValidationTextarea("sprytextarea1", {validateOn:["blur"], minChars:10, hint:"min. 10 chars"});
var sprytextfield1 = new Spry.Widget.ValidationTextField("sprytextfield1", "none", {validateOn:["blur"]});
var sprytextfield2 = new Spry.Widget.ValidationTextField("sprytextarea2", {validateOn:["blur"], minChars:10, hint:"min. 10 chars"});
var sprytextfield3 = new Spry.Widget.ValidationTextField("sprytextfield3", "none", {validateOn:["blur"]});
var sprytextfield4 = new Spry.Widget.ValidationTextField("sprytextfield4", "none", {validateOn:["blur"]});
var sprytextfield5 = new Spry.Widget.ValidationTextField("sprytextfield5", "email");
var sprytextfield6 = new Spry.Widget.ValidationTextField("sprytextfield6", "integer", {validateOn:["blur"], hint:"10-digit no."});
...
var sprytextfield9 = new Spry.Widget.ValidationTextField("sprytextfield9", "email", {isRequired:false, validateOn:["blur"]});
var sprytextfield10 = new Spry.Widget.ValidationTextField("sprytextfield10", "integer", {validateOn:["blur"], isRequired:false, hint:"10-digit no.", minChars:10, maxChars:10});
var sprytextfield11 = new Spry.Widget.ValidationTextField("sprytextfield11", "none", {isRequired:false, validateOn:["blur"]});
var sprytextfield12 = new Spry.Widget.ValidationTextField("sprytextfield12", "none", {isRequired:false, validateOn:["blur"]});
var sprytextfield13 = new Spry.Widget.ValidationTextField("sprytextfield13", "email", {isRequired:false, validateOn:["blur"]});
var sprytextfield14 = new Spry.Widget.ValidationTextField("sprytextfield14", "integer", {isRequired:false, hint:"10-digit no.", minChars:10, maxChars:10, validateOn:["blur"]});
      </script>
</body>
</html>
