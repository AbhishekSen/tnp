								  ...
								  <div class="tabbertab" id="step[3]">
									...
									<table width="640" height="523" align="center" cellpadding="5" cellspacing="5">
									  ...
									  <tr>
										...
										<td ><label>
										  <input name="shortlist" id="bond2" type="radio" value="1" <% if(shortlist.equals("1")&& Float.parseFloat(cpi)>0 )out.println("checked"); %> onClick="enabletxt();">
										</label>
										  Yes
										  <label>
									  ...
									  <tr>
										...
										<td><input name="cpi_other" type="text" id="cpi_other" value="<%=cpi_other%>" size="60" onkeypress="return alpha(event);" ></td>
									  </tr>
									  <tr>
									 ...
									 <tr>
									  ...
									  <tr>
										<td height="32" ><p>*Profile Name(e.g. GET,MT) </p></td>
									...
									<table width="640" height="129" align="center" cellpadding="5" cellspacing="5">									  
									  <tr>
									   <td height="32"><b>Programs at a Glance</b></td>
									  </tr>
									  <tr>
									  <td nowrap>
									  <table border="1" align="center" id="programs_table">
									  <tr>
									  ...
									  <tr>
										...
										<tr>
										<td height="32">Please Select your choices:</td>
										</tr>
										<tr>
										<td nowrap>
										  <p>
