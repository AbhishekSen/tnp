...
.wrapper.row3 #container #portfolio .clear #form2 table tr td .aa {
	text-align: right;
}
</style>
...
<form name="form2" id="form2"  class="aa" method="post" onSubmit="return validate_empty();" action="vacancy_temp.jsp"><input type="hidden" name="id" value="<%=package_id%>"/>
			<table width="100%" align="center" style="border:groove">
				
				<tr>
				<td>
					<h2 align="center">Job Profile Form</h2>
					<table  class="aa" width="100%" height="523" cellpadding="5" cellspacing="5" border="1" >
					  <tr>
						<td width="40%" height="32" class="aa" >*Job description</td>
						<td width="60%" class="ab" ><span id="sprytextarea1">
					  ...
					  <tr>
						<td height="32" class="aa" >*Job designation </td>
					  ...
					  <tr>
						<td height="32" class="aa" >*Place of posting </td>
					  ...
					  <tr>
						<td height="31" class="aa" >*Shortlist by cpi?</td>
						<td class="ab" ><label>
					  ...
					  <tr>
						<td height="32" class="aa" >Minimum Cpi (Students profile having this minimum CPI or above will only be accessible)</td>
						<td class="ab"><span id="sprytextfield3">
					...
					<tr>
						<td height="32" class="aa" >Tenth Percentage</td>
					  ...
					  <td height="32" class="aa" >Twelfth Percentage</td>
					  ...
					  <tr>
						<td height="32" class="aa" ><p>Other requirements</p></td>
						<td class="ab"><input name="cpi_other2" type="text" id="cpi_other4" value="<%=cpi_other%>" size="60" onkeypress="return alpha(event);" ></td>
					  </tr>
					  <tr>
						<td height="32" class="aa">*No. of vacancy :</td>
						<td class="ab"><input name="vacancy1" type="text" id="vacancy1" value="<%=vacancy1%>" onkeypress="return alpha(event);"></td>
                                          </tr>
                                          <tr>
                                                <td height="32" class="aa">*Currency Details:</td>
					  ...
					  <tr>
						<td height="32" class="aa">*CTC B.Tech:</td>
						<td class="ab"><input name="ctc1" type="text" id="ctc1" value="<%=ctc1%>" onkeypress="return alpha(event);">
						  <%=curr%></td>
					  </tr>
					  <tr>
						<td height="32" class="aa">*CTC M.Tech:</td>
						<td class="ab"><input name="ctc_mtech" type="text" id="ctc_mtech" value="<%=ctc_mtech%>" onkeypress="return alpha(event);">
						  <%=curr%></td>
					  </tr>
					  <tr>
						<td height="32" class="aa">*CTC M.Sc:</td>
						<td class="ab"><input name="ctc_msc" type="text" id="ctc_msc" value="<%=ctc_msc%>" onkeypress="return alpha(event);">
						  <%=curr%></td>
					  </tr>
                                          <tr>
		           	             <td height="32" class="aa">*CTC M.A.(Development Studies):</td>
			                     <td class="ab"><input name="ctc_ma" type="text" id="ctc_ma" value="<%=ctc_ma%>">
				             <%=curr%></td>
	                                  </tr>

					  <tr>
						<td height="32" class="aa">*CTC Ph.D:</td>
						<td class="ab"><input name="ctc_phd" type="text" id="ctc_phd" value="<%=ctc_phd%>" onkeypress="return alpha(event);">
						  <%=curr%></td>
					  </tr>
					  <tr>
						<td height="32" class="aa">*Gross B.Tech:</td>
						<td class="ab"><input name="gross" type="text" id="gross" value="<%=gross%>" onkeypress="return alpha(event);">
						  <%=curr%></td>
					  </tr>
					  <tr>
						<td height="32" class="aa">*Gross M.Tech:</td>
						<td class="ab"><input name="gross_mtech" type="text" id="gross_mtech" value="<%=gross_mtech%>" onkeypress="return alpha(event);">
						  <%=curr%></td>
					  </tr>
					   <tr>
						<td height="32" class="aa">*Gross M.Sc:</td>
						<td class="ab"><input name="gross_msc" type="text" id="gross_msc" value="<%=gross_msc%>" onkeypress="return alpha(event);">
						  <%=curr%></td>
					  </tr>
                                          <tr>
			                     <td height="32" class="aa">*Gross M.A.(Development Studies):</td>
				             <td class="ab"><input name="gross_ma" type="text" id="gross_ma" value="<%=gross_ma%>">
				             <%=curr%></td>
			                  </tr>
					   <tr>
						<td height="32" class="aa">*Gross Ph.D:</td>
						<td class="ab"><input name="gross_phd" type="text" id="gross_phd" value="<%=gross_phd%>" onkeypress="return alpha(event);">
						  <%=curr%></td>
					  </tr>
					  <tr>
						<td height="32" class="aa">Take Home during training period :</td>
						<td class="ab"><input name="take_home_during" type="text" id="take_home_during" value="<%=take_home_during%>" onkeypress="return alpha(event);">
						  <%=curr%></td>
					  </tr>
					  <tr>
						<td height="32" class="aa">Take Home after training period :</td>
						<td class="ab"><input name="take_home_after" type="text" id="take_home_after" value="<%=take_home_after%>" onkeypress="return alpha(event);">
						  <%=curr%></td>
					  </tr>
					  <tr>
						<td height="32" class="aa">Bonus/Perks/Incentive (if any):</td>
						<td class="ab"><input name="bonus" type="text" id="bonus" value="<%=bonus%>" size="60" onkeypress="return alpha(event);"></td>
					  </tr>
					  <tr>
						<td height="31" class="aa" >Bond</td>
						<td class="ab" ><input name="bond1" id="bond1" type="radio" value="1" <% if(bond.equals("1"))out.println("checked"); %> onClick="enabletxt1();">
						  Yes
						  <input name="bond1" id="bond1" type="radio" value="0" <% if(bond.equals("0"))out.println("checked"); %> onClick="enabletxt1();">
						  NO</td>
					  </tr>
					  <tr>
						<td height="32" class="aa" ><p>Bond details </p></td>
						<td class="ab"><input name="bond_details" type="text" id="bond_details" value="<%=bond_details%>" size="60" onkeypress="return alpha(event);" <%if(bond.equals("0")) out.println("disabled");%> ></td>
					  </tr>
					  <tr>
						<td height="35" class="aa" >*Profile Name</td>
						<td class="ab"><span id="sprytextfield6">
						  <input name="package_name1" type="text" id ="package_name1" value="<%=package_name1%>" onKeyPress="return alpha(event);">
					    <span class="textfieldRequiredMsg">A value is required.</span></span></td>
					  </tr>
					</table>
					<table class="aa" width="100%" align="center" cellpadding="5" cellspacing="5" style="border:groove">
					  <tr>
						<td height="32"><b>Department</b></td>
						<td class="ab">Please Select your choices:</td>
					  </tr>
					  <tr>
						<td height="40">&nbsp;</td>
						<td nowrap class="ab"><p>
						  ...
						  <table width="80%" class="aa"border="1" align="center" id="btech_table">
							<tr>
							  <td width="50%" class="ab"><label>
						  ...
						  <table width="80%" class="aa"border="1" name="mtech_table" id="mtech_table">
							<tr>
							  <td width="50%">Biotechnology</td>
							  <td width="50%" class="ab"><p>
								<label>
						...
						<br/>
						<label><input type="checkbox" name="mtech_chkbox" value="45" <% if(deps[45]==1)out.println("checked"); %> id="mtech_chkbox_11">Power and Control</label>
							<br/>
						  ...
						  <table  class="aa" width="30%" border="1" id="msc_table" name="msc_table">
							<tr>
							  <td><p>
								<span class="ab">
								<label>
						  ...
						  <table  class="aa"width="80%" border="1" ali align="center"id="phd_table" name="phd_table">
							<tr>
							  <td width="50%"class="ab"><p>
								<label>
						  ...
						  <p>&nbsp;</p></td>
										  ...
										  <tr><td class="aa" >Major Department</td><td class="ab" >Minor Department</td></tr>
			  ...
			  <tr>
				<td align="center"><input name="submit" type="submit" class="button" id="submit" value="Submit"/>
	    </td>
			  </tr>
              </table>
			  </form>
