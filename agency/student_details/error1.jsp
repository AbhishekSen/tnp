...
<!--placement\agency\student_details   -->
<html>
<head>
    ...
    <div id="portfolio"  class="three_quarter">
      <ul class="clear">
 				 ...
 				 <div id = "center" class = "center">
						  <div class="feature">
							  <form method="post" name="form_agency_registration" id="form_agency_registration" onSubmit="return validate_empty(form_agency_registration)" action="update.jsp">
								<p>&nbsp;</p>
								<p>&nbsp;</p>
								<p align="center"><strong>Student is either not eligible or interested in your profile.</strong></p>
								<p>&nbsp;</p>
							  </form>
