...
<div id="pagecell1"> 
  ...
  <div id="pageNav">
    <div id="sectionLinks">  
      ...
      <a href="../vacancies/add_vacancy.jsp">Job Profile &amp; Salary Details</a><a href="eligibility.jsp">Eligible Students</a>
      <a href="../student_details/student_details.jsp">Students Details Query</a>
      <a href="../cv_query/cv_query.jsp">CV Query</a>
      <a href="../calendar/view.jsp">Company Schedule</a><a href="../uploads/upload.jsp">Upload Company Literature</a>
  ...
  <div id="content"> 
    <div class="feature">
      ...
      <p align="center"><strong>Access Denied, for the particular Company Name</strong></p>
