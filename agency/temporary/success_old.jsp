...
<div id = "container">
    ...
    <p align="center">Steps following initial registration:</p>
      <ul> 
          <li>You will be receiving login credentials from noreply@iitg.ernet.in </li>
          <li>After receiving the credentials, kindly visit https://auto.iitg.ernet.in/tnp and log on to company login</li>
          <li>After successful login, fill the job announcement form and salary details</li>    
          <li>Any document and pdf having other details about the organization can be uploaded in organization literature tab </li>
          <li>Placement cell will be approving your profile and thereafter you can view the eligible student details </li>
          <li>Please feel free to contact placement cell in case of any queries</li>
    </ul>
    <br/>
    <p align="center">Contact details of Training and Placement Cell-
    <br/>Email: placement@iitg.ernet.in
    <br/>Phone: 0361 2582175</p><br/>
													<p align="center">&nbsp;</p>
													<p align="center">&nbsp;</p>
													<p align="center">&nbsp;</p>
													<p align="center">&nbsp;</p>
              ...
              <div id = "footer">
              <span>© 2013  Indian Institute of Technology Guwahati. Queries to: webmaster[at]iitg.ernet.in</span>
            </div>
            </div>
        </div>
</body>
