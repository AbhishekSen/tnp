...
<%
	...
	//String strPropPath="/opt/tomcat7/webapps/placement/placement.properties";
      ...
      String str_path=gpath+"placement_up loads/agency/company_literature/";   
...
String ff=gpath+"placement_uploads/agency/company_literature/"+filename ;
...
if(success)
{
			  ...
			  ResultSet rf=db.execSQL("select agency_id from agency where username='"+username1+"'");
				if(rf.next())
				{
					agency_id=rf.getString("agency_id"); 
                                                                             
				}
				rf.close();
			
			
			int s1=db.updateSQL("delete from company_literature where file_name='"+filename+"' and  agency_id="+agency_id+";");
    ...
    <div id="portfolio"  class="three_quarter">
      <ul class="clear">
       ...
       <div id = "center" class = "center">
						  ...
						  <p align="center"><strong>Can not delete the file!!!</strong></p>  
						  </div>
