...
<div id="pagecell1"> 
  ...
  <div id="pageName"> 
    <h2>Welcome</h2>
    <img alt="small logo" src="../images/logo-top.gif" height="78" width="91"/></div>
  <div id="pageNav">
    <div id="sectionLinks">
      ...
      <a href="browse.jsp" >Download OrganizationLiterature</a>
   ...
   <form method="post" name="form_agency_registration" id="form_agency_registration" action="process.jsp" >
        <p>&nbsp;</p>
        <p align="center"><strong>Company literature not found.</strong></p>
        <p>&nbsp;  </p>
        <p>&nbsp;</p>
      </form>
