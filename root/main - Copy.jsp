...
<div id="pagecell1"> 
  ...
  <div id="pageNav"> 
    <div id="sectionLinks"> 
      <a href="placement_record/getinfo.jsp" target="_blank">Placement Record</a>
      ...
      <a href="placement_query1/agency_year.jsp" target="_blank">Agency Query</a>
      <a href="second_card/second_card.jsp" target="_blank">Second Card Query</a>
      <a href="agency_date/agency_date.jsp" target="_blank">Agency Date Query</a>
      ...
      <a href="placement_query3/placement_query1.jsp" target="_blank">Agency Query by Deptt/Prog</a>
      <a href="temporary_query/placement_query.jsp" target="_blank">Temporary Agency Query</a>
      <a href="average_package/average_package.jsp" target="new">Average Package Query</a>
      <a href="placement_schedule/schedule.jsp" >Placement Schedule</a>
      <a href="make_permanent/activate.jsp" target="new">Activate Temporary Agencies</a>
