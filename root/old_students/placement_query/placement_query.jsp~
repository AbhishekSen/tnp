...
<div id="pagecell1"> 
  ...
  <div id="content"> 
    <div class="feature">
      <form method="post" name="form_agency_registration" id="form_agency_registration" onSubmit="return validate_empty(form_agency_registration)" action="details.jsp">
