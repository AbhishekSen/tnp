...
<%@page language="java" import="pack.DbBean4"%> 


<jsp:useBean id="db4" class="pack.DbBean4" scope="session" />
...
<div id="pagecell1"> 
  ...
  <div id="content"> 
    <div class="feature">
      <form method="post" name="form_agency_registration" id="form_agency_registration" onSubmit="return validate_empty(form_agency_registration)" action="details_2013_2014.jsp">
        ...
        <table width="65" height="32" border="0" align="center">
          <tr>
            <td><div align="center">
        <button style="width:4cm; ">Get Details</button>
        <colgroup>
          </colgroup>
      </div></td>
          </tr>
  ...
  <div id="siteInfo"><a href="#">About Us</a> | <a href="#">Site
    Map</a> | <a href="#">Privacy Policy</a> | <a href="#">Contact Us</a> | &copy;2014
    Company Name
  </div> 
</div> 
<!--end pagecell1--> 
