...
<script src="../js/downloadCompanyJAF.js"></script>
...
<div id="pagecell1"> 
  ...
  <div id="sectionLinks"> 
    ...
    <div id="content"> 
    <div class="feature">
     <form name="form_query_placement" id="form_query_placement" method="post" action="getProfileDetails.jsp" onsubmit="return checkEmpty();">
        <br>
        ...
        <table width="644" height="67" align="center">
          <tr>
            ...
            <td><p>
              <select name="company_name" id="company_name" onChange="selectedCompanyChanged(this);">
                <%!String company_list;%>
                <%  
                    db.fetchConfigDetails(); //newly added
                    db.connect();
                    company_list=my_drop_down("select agency_id,agency_name from agency;",db,"-------------------Select a company--------------------" );
                   db.close(); %>
        ...
        <table width="76" height="32" border="0" align="center">
          <tr>
            <td><input type="submit" class="center" name="get_profile_details" id="get_profile_details"  value="Get Data" disabled = "true"></td>
          </tr>
        </table>
        <br>
        <br>
