...
if(id.equals("0"))
{
	out.println("  <center><p><strong>Organization details(Whole Agency) successfully deleted!!!</strong></p></center> ");
}
else if(id.equals("1"))
{
	out.println("  <center><p><strong>Organization details(Selected package) successfully deleted!!!</strong></p></center> ");
}
%>
    </div> 
  </div>
