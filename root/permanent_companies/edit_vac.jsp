...
<%
	...
	int age_id=0;
	int tag=0;
	ResultSet re=db.execSQL("select agency_id,package_id,package_name from package_details order by agency_id;");
	...
	while(re.next()&&re!=null)
	{
		if(age_id!=re.getInt("agency_id"))
		{
			...
			out.println("<br/><a href=\"edit.jsp?id="+re.getInt("package_id")+"\">"+re.getString("package_name")+"</a>");
