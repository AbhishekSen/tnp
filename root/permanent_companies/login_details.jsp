...
<%
	...
	db.connect();
	int co=1;
	ResultSet re=db.execSQL("select username,password from login;");
	out.println("<table width=400 align=\"center\" border=\"1\"><b><tr><td>S.No.</td><td>Username</td><td>Password</td></tr></b>");
	while(re.next())
	{

	    out.println("<tr><td>"+co+"</td><td>"+re.getString("username")+"</td><td>"+re.getString("password")+"</td></tr>");
	    co++;
	}
	out.println("</table>");
	re.close();
