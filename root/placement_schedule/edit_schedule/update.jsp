...
{	
	...
	if(document.form_placement_record.month.value=="")
		message+="Please enter Month\n";
	if(document.form_placement_record.day.value=="")
		message+="Please enter Day\n";
        if(document.form_placement_record.year.value=="")
		message+="Please enter Year\n";
		
	
	if(message=="")
	{
		document.form_placement_record.action="update.jsp";
		return true;
	}
	else
	{
...
<div id="pagecell1"> 
  ...
  <div id="pageName"> 
    <h2>Welcome</h2>
    <img alt="small logo" src="../../images/logo-top.gif" height="60" width="50"/></div> 
  <div id="pageNav"> 
    <div id="sectionLinks"> 
...
<%
	...
	{				
	   int num_rows=0;
	   String main_record=" update schedule set date_from='"+date_from+"',starting_time='"+starting_time+"',date_to='"+date_to+"',end_time='"+end_time+"',description='"+description+"',venue='"+venue+"',eligibility_criteria='"+eligibility_criteria+"',departments='"+departments+"' where agency_id="+Integer.parseInt(agency_id)+";";
...
%>
    ...
    <%	if(submit2==null)
	{
		String sql_get_data="select * from schedule where agency_id="+Integer.parseInt(agency_id)+";" ;
		db.connect(); 
