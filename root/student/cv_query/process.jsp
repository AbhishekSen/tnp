  ...
  <div id="content"> 
    <div class="feature">
      ...
      <%                    
				...
				out.println("<p align=\"center\"> <a href=\"down_cv.jsp?roll_no="+student_roll_number+"\" ></p>");
				out.println("<p align=\"center\"><strong>Click Here to download the CV1 for Roll Number , "+student_roll_number+" </a></strong></p>");
                                out.println("<p align=\"center\"> <a href=\"down_cv2.jsp?roll_no="+student_roll_number+"\" ></p>");
				out.println("<p align=\"center\"><strong>Click Here to download the CV2 for Roll Number , "+student_roll_number+" </a></strong></p>");
