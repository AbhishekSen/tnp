...
{	
	...
	if(document.form_agency_registration.agency_name.value=="")
		message+="Please enter Agency name\n";
		
	
	if(message=="")
	{
		document.form_agency_registration.action="interested.jsp";
		return true;
	}
	else
	{
		alert(message);
		document.form_agency_registration.action=null;
		return false;
	}
}	 
...
<div id="pagecell1"> 
  ...
  <div id="content"> 
    <div class="feature">
      <form method="post" name="form_agency_registration" id="form_agency_registration" onSubmit="return validate_empty()">
