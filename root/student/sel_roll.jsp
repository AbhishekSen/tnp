...
<div id="pagecell1"> 
  ...
  <form name="form1" method="post" action="add_uname.jsp">
    <p align="center">
      ...
      <%
		...
		db.connect();
		ResultSet re=db.execSQL("select student_roll_number from student_record where username is null;");
		while(re.next())
		{
			out.println("<option value=\""+re.getString(1)+"\">"+re.getString(1)+"</option>");
		}
		re.close();
		db.close();
