...
<div id="pagecell1"> 
  ...
  <div id="content"> 
    <div class="feature">
      ...
      <p align="center">&nbsp;</p>
      <%
			File file1=new File(gpath+"placement_uploads/student/uploads"+"/"+student_roll_number+".pdf");
			if(file1.exists())
			{
				out.println("<p align=\"center\"> <a href=\"../../../students/uploads/"+student_roll_number+".pdf\" ></p>");
				out.println("<p align=\"center\"><strong>Click Here to download the CV for Roll Number , "+student_roll_number+" </strong></p>");
			}
			else
			{
				out.println("<p align=\"center\"><strong>The Students CV has not been uploaded.</strong></p>");
			}
	  %>
