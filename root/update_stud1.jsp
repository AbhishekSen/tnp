 <%@page language="java" import="java.util.*,gcom.*,java.lang.*,java.sql.*" %>
...
out.println("<form name=\"form1\" method=\"post\" action=\"update_stud3.jsp?prog="+prog+"\" enctype=\"multipart/form-data\">");
    //<td>&nbsp;</td>
    //<td>
