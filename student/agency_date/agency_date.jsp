...
<div id="pagecell1"> 
  ...
  <div id="pageNav"> 
    <div id="sectionLinks"> 
      <a href="placement_record/record.jsp" >Placement Record</a>
      <a href="drop_agency/drop.jsp" >Drop Organization</a>
	  <a href="attendance/placement_record.jsp" >Organization Exam Appearance</a>
	  <a href="temporary_drop_agency/tempdrop.jsp" >Drop Temporary Organization</a>
      <a href="read/index_single_upload.jsp" >CV Query</a>
      <a href="queries/placement_query/placement_query.jsp" >Student Query</a>
      <a href="queries/placement_query1/placement_query1.jsp" >Organization Query</a>
      <a href="queries/second_card/second_card.jsp" >Second Card Query</a>
      <a href="queries/agency_date/agency_date.jsp" >Organization Date Query</a>
      <a href="queries/eligibility_query/eligibility_query.jsp" >Student Eligibilty Query</a>
      <a href="queries/agency_date/agency_date.jsp" >Job Query</a>
      <a href="download_student/download_student.jsp" >Attendence Query</a>
      <a href="download_agency/download_agency.jsp" >Organization Query by Deptt/Prog</a>
      <a href="queries/temporary_query/placement_query.jsp" >Temporary Organization Query</a>
