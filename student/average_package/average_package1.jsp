...
<div id="pagecell1"> 
  ...
  <div id="pageNav">
    <div id="sectionLinks">
      <a href="../student_registration/student_registration.jsp" target="_blank">Register </a>
      <a href="../student_registration/edit.jsp" target="_blank">Edit Registration Details</a>
	  <a href="../upload_cv/upload.jsp" target="blank">Upload CV</a>
	  <a href="../student_performance/student_eligibility.jsp" target="blank">Check Eligibility</a>
      <a href="../schedule/agency_date.jsp" target="blank" >Organization Dates</a>
      <a href="list.jsp">Organization's Visiting</a>
      <a href="../agency_query/placement_query.jsp" target="_blank">Organization Details</a>
      <a href="../vacancies/vacancies.jsp" target="blank">Vacancies</a>
...
<%
	   ...
	   out.println(display1+"Following Companies Have Registered So Far !"+display2);  
       ...
       out.println("</tr>");	
		...
		while(rs.next()) 
		{
				...
				i++;
             	out.println("<tr><td>"+i+"</td><td>"+agency_name+"</td><td>"+agency_profile+"</td></tr>");
