...
<div id="pagecell1"> 
  ...
  <div id="sectionLinks"> 
      ...
      <a href="../placement_query1/placement_query1.jsp" target="_blank">Organization Query</a>
      ...
      <a href="../agency_date/agency_date.jsp" target="_blank">Job Query</a>
      ...
      <a href="average_package.jsp" target="new">Average Package Query</a>
      <a href="../personal_details/placement_query.jsp" target="new">Personal Details Query</a>
