...
function uploadIMGCheck(flag)
{
    var msg=document.getElementById("messages");
    msg.innerHTML="";
    if(flag == 1)
    {
        var url = "../upload_img/check.jsp?id=1";
    ...
    if(httpRequest1.readyState == 4)
    {
	    ...
	    //var xmlDoc=httpRequest1.responseXML;
            ...
            else if(err[0].childNodes[0].nodeValue == "2")
            {
                ...
                ele1.innerHTML = "<p>Image already uploaded.</p>";
...
function downloadIMG(flag)
{
    var url = "../upload_img/down_img.jsp?cv_id=" + flag;
