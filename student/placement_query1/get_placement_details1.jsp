...
//out.println(button_value+check_agency_year+agency_year);
        db.fetchConfigDetails(); //newly added
	
	int agency_id=0;
	
	String get_id="select agency_id from agency where agency_year='"+agency_year+"';";
	db.connect();
...
//	}
	...
	{ 
		...
		sql_where.append(" where P.agency_year="+agency_year ) ;
		
		

		//if(check_agency_year.equals("true"))
...
{out.println("No data is available for the year "+agency_year);}
