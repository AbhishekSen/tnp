...
<div id="masthead"> 
 <h1 id="siteName">Training &amp; Placement Cell - IIT Guwahati.</h1> 
  ...
  <div id="globalNav"> 
    ...
    <div id="globalLink"> 
      <a href="jp.jsp" id="gl1" class="glink" onMouseOver="ehandler(event,menuitem1);">Registration Details</a><a href="../dates/arrival.jsp" id="gl2" class="glink" onMouseOver="ehandler(event,menuitem2);">Arrival Date</a><a href="../modifications/modify.jsp" id="gl3" class="glink" onMouseOver="ehandler(event,menuitem3);">Modifications </a><a href="#" id="gl4" class="glink" onMouseOver="ehandler(event,menuitem4);">Exam Dates</a><a href="../../logout.jsp" id="gl5" class="glink" onMouseOver="ehandler(event,menuitem5);">LogOut</a></div> 
    <!--end globalLinks--> 
...
<div id="pagecell1"> 
  ...
  <div id="pageNav"> 
  <div id="sectionLinks"> 
      <p><a href="placement_record/record.jsp" target="_blank">Placement Record</a>
