...
%>
     <% 
		...
		String img_absolute_path="http://localhost:8080/placement_uploads/student/uploads/";
	String img_path="";
	  String name="",dob="",sex="";
	  String category="";
	  String jee_rank="";
     ...
     %>
        <div class="wrraper">
			...
			<img src="iitg_web_mid.gif" width="119" height="99">
				...
				<div class="passImg">
				<img src="<%=img_path%>"width="119" height="116">
				
		                    </div>   
				<div class="passSign">
				<img src="<%=sign_path%>"width="119" height="50">
                    ...
                    <div class="row">
                        <div class="roll_no">
                                ...
                                <div class="right_roll_no" style="font-size:12px;">
                                    <b>:</b><b class="bld_inp">(1)&nbsp;<%=username%>@iitg.ernet.in &nbsp;&nbsp;&nbsp;(2)&nbsp;<%=email2%></b>
                                </div>    
                        </div>  
                    </div>
                    <div class="row">
