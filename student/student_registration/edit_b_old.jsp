          ...
          <tr>
            <td bgcolor="#FFFFFF"><div class="tabber">
			  ...
			  <option value="FOREIGN STUDENT" <% if(category.equals("FOREIGN STUDENT"))out.println("selected"); %>>FOREIGN STUDENT</option>
                    ...
                    <tr>
                      <td>Minor Programme</td>
                      <td><%=minor_program_name%></td>
                    </tr>
              ...
              <div class="tabbertab" id="step[2]">
                ...
                <center>
                  <table align="center" cellpadding="5" cellspacing="5">
                    ...
                    <tr>
                    <td height="34"><span id="sprytextfield26">
              ...
              <div class="tabbertab" id="step[3]">
                <h2>Choice Sheet</h2>
                <p>&nbsp;</p>
                <table width="750" height="192" align="center" cellpadding="5" cellspacing="5">
                <tr>
                        <td><input type="checkbox" name="ppo" id="ppo" value="Y"  onchange="updatePPO(this);">Got PPO?</td>
                        <td>Dream Company(if any):<br><input type="text" name="dream_company" id="dream_company" value="<%=dream_company%>"></td>
                </tr>
                <tr></tr>
                <tr></tr>
