            ...
            <td bgcolor="#FFFFFF">
                ...
                <center>
                  ...
                  <table width="80%" border="1" align="center" cellpadding="5" cellspacing="5" style="border:groove">
                    ...
                    <tr>
                      <td>*Category<br><span style="font-size:10px">(SC/ST/OBC/GEN/PH/Foreign)</span></td>
...
%>
              ...
              <h2 align="center">Academic Details</h2>
                 <table width="100%" align="center" cellpadding="5" cellspacing="5" style="border:groove" border="1">
                 <tr>
                    <td width="20%">Level</td>
                    <td width="20%">Board/University</td>
                    <td width="20%">Medium of Education</td>
                    <td width="20%">Class/Div</td>
                  ...
                  <tr>
                    <td><p>*Graduation<br>Degree:
                        ...
                        <span class="textfieldRequiredMsg">A value is required.</span></span><br>Branch:
...
No</td>
              ...
              <br> <h3 width="90%" align="center">Post Graduation</h3>
            <table align="center" cellpadding="5" cellspacing="5">
                  <tr>
                    <td><table align="center" cellpadding="5" cellspacing="5" border="1" style="border:groove">
                      
                      <tr>
                        <td style="font-style:oblique; font-weight:bold">SPI in all semesters</td>
...
<tr>
                        ...
                        <td><%=cpi%></td> <td>Backlog<br/><input type="radio" name="backlog" value="1" <% if(backlog.equals("1")) out.println("checked"); %>/>
                        Yes
              ...
              <h3 width="90%" align="center">Job Preference</h3>
               
<table align="center" cellpadding="5" cellspacing="5" border="1" style="border:groove">
                   <tr>
                        <td>Preferred Job</td>
                        <td>Core Sector</td>
                        <td>Govt. Sector</td>
                      ...
                      <tr>
                        <td>Rank 1-5 [1=most likely,5=least likely]</td>
...
var sprytextfield4 = new Spry.Widget.ValidationTextField("sprytextfield4", "none", {hint:"ex: A001", minChars:3, maxChars:5, validateOn:["blur"]});
var sprytextfield5 = new Spry.Widget.ValidationTextField("sprytextfield5", "email", {validateOn:["blur"], hint:"abc@iitg.ernet.in"});
var sprytextfield6 = new Spry.Widget.ValidationTextField("sprytextfield6", "email", {validateOn:["blur"]});
var sprytextfield7 = new Spry.Widget.ValidationTextField("sprytextfield7", "integer", {validateOn:["blur"], minChars:10, maxChars:10, hint:"10-digit no."});
var sprytextfield8 = new Spry.Widget.ValidationTextField("sprytextfield8", "none", {validateOn:["blur"]});
var sprytextfield9 = new Spry.Widget.ValidationTextField("sprytextfield9", "integer", {validateOn:["blur"], minChars:6, maxChars:8});
var sprytextfield10 = new Spry.Widget.ValidationTextField("sprytextfield10", "integer", {validateOn:["blur"], hint:"only digits"});
var sprytextfield11 = new Spry.Widget.ValidationTextField("sprytextfield11", "none", {validateOn:["blur"], hint:"ex: CBSE"});
var sprytextfield12 = new Spry.Widget.ValidationTextField("sprytextfield12", "none", {validateOn:["blur"], hint:"ex: English"});
var sprytextfield13 = new Spry.Widget.ValidationTextField("sprytextfield13", "none", {validateOn:["blur"], hint:"ex: First"});
var sprytextfield14 = new Spry.Widget.ValidationTextField("sprytextfield14", "real", {validateOn:["blur"], minValue:1, maxValue:100});
var sprytextfield15 = new Spry.Widget.ValidationTextField("sprytextfield15", "integer", {validateOn:["blur"], hint:"YYYY", minChars:4, maxChars:4});
var sprytextfield16 = new Spry.Widget.ValidationTextField("sprytextfield16", "none", {validateOn:["blur"], hint:"ex: ICSE"});
var sprytextfield17 = new Spry.Widget.ValidationTextField("sprytextfield17", "none", {validateOn:["blur"], hint:"ex: Hindi"});
var sprytextfield18 = new Spry.Widget.ValidationTextField("sprytextfield18", "none", {validateOn:["blur"], hint:"ex: First with Hons."});
var sprytextfield19 = new Spry.Widget.ValidationTextField("sprytextfield19", "real", {validateOn:["blur"], minValue:1, maxValue:100});
var sprytextfield20 = new Spry.Widget.ValidationTextField("sprytextfield20", "integer", {validateOn:["blur"], hint:"YYYY", minChars:4, maxChars:4});
var sprytextfield21 = new Spry.Widget.ValidationTextField("sprytextfield21", "none", {validateOn:["blur"], hint:"ex: University's name"});
var sprytextfield22 = new Spry.Widget.ValidationTextField("sprytextfield22", "none", {validateOn:["blur"], hint:"ex: English"});
var sprytextfield23 = new Spry.Widget.ValidationTextField("sprytextfield23", "none", {validateOn:["blur"], hint:"ex: First"});
var sprytextfield24 = new Spry.Widget.ValidationTextField("sprytextfield24", "real", {validateOn:["blur"], minValue:1, maxValue:100});
var sprytextfield25 = new Spry.Widget.ValidationTextField("sprytextfield25", "integer", {validateOn:["blur"], hint:"YYYY"});
var sprytextfield26 = new Spry.Widget.ValidationTextField("sprytextfield26", "none", {hint:"ex: BTech"});
var sprytextfield27 = new Spry.Widget.ValidationTextField("sprytextfield27", "none", {validateOn:["blur"], hint:"ex: CSE"});
