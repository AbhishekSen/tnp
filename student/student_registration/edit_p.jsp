...
<%	
	...
	Calendar rightNow = Calendar.getInstance();
 	System.out.println("Inside edit_p.jsp");
	...
	{  	
		System.out.println("Inside updating database");
		db.connect();
		if(spec!=null)
		{
            ...
            <td bgcolor="#FFFFFF">
                ...
                <center>
                  <table width="80%" border="1" align="center" cellpadding="5" cellspacing="5" style="border:groove">
                    <tr>
                      <td width="40%" style="text-align: right">Student roll number</td>
                      <td width="60%" style="text-align: left"><%=student_roll_number%></td>
                    </tr>
                    <tr>
                      <td style="text-align: right">Name(Capital Letter)</td>
                    ...
                    <tr>
                      ...
                      <td style="text-align: left"><input name="sex" type="radio" id="sex" value="1" checked <% if(sex.equals("1")){out.println("checked");} %>>
                        Male
                        <input type="radio" name="sex" id="sex" value="0" <% if(sex.equals("0")){out.println("checked");} %>>
                        Female</td>
                    </tr>
                     <tr>
                      <td style="text-align: right">*Category<br><span style="font-size:10px">(SC/ST/OBC/GEN/PH/Foreign)</span></td>
                      <td style="text-align: left"><label for="category"></label>
			  ...
			  <option value="FOREIGN STUDENT" <% if(category.equals("FOREIGN STUDENT"))out.println("selected"); %>>FOREIGN STUDENT</option>
                    ...
                    <tr>
                      ...
                      <td style="text-align: left"><input type="text" name="nationality" value="<%=nationality%>"></td>
                    </tr> 


                    <tr>
                      <td style="text-align: right">Programme</td>
                      <td style="text-align: left"><p><%=program_name%></p>
                        <p>
<%
...
%>
                    ...
                    <tr>
                      <td style="text-align: right">*Qualifying Examination</td>
                      <td style="text-align: left"><select name="exam" id="exam" onChange="examination()">
                    ...
                    <tr>
                      <td style="text-align: right">*Hostel</td>
                      <td style="text-align: left"><span id="spryselect1">
                      ...
                      <tr>
                      <td style="text-align: right">*Room No.</td>
                    ...
                    <tr>
                      ...
                      <td style="text-align: left"><span id="sprytextfield5">
                    ...
                    <tr>
                      <td style="text-align: right">*Contact Telephone/Mobile No.</td>
                      <td style="text-align: left"><span id="sprytextfield6">
                        <input type="text" name="mobile1" value="<%=mobile1%>">
                      <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                    </tr>
                    <tr>
                      <td style="text-align: right">Alternate Telephone/Mobile No.</td>
                      <td style="text-align: left"><input type="text" name="mobile2" value="<%=mobile2%>"></td>
                    </tr>
                    <tr>
                      <td height="150" style="text-align: right">*Permanent Address</td>
                      <td style="text-align: left">Line 1:<span id="sprytextfield7">
                    ...
                    <tr>
                      ...
                      <td style="text-align: left"><span id="sprytextfield8">
                        <input type="text" name="pin" value="<%=pin%>">
                      <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                    </tr>
                    <tr>
                      <td style="text-align: right">*Home Telephone No.(with code)</td>
                      <td style="text-align: left"><span id="sprytextfield9">
                        <input type="text" name="telephone" value="<%=telephone%>">
                      <span class="textfieldRequiredMsg">A value is required.</span></span></td>
                    </tr>
                  </table>
            </center>
                <h2 align="center">Academic Details</h2>
                <table width="1000" align="center" cellpadding="5" cellspacing="5" border="1" style="border:groove">
                 <tr>
                    <td>Level</td>
...
No</td>
                ...
                <center>
                 <br><h2>Thesis Related</h2>
                 <table align="center" cellpadding="5" cellspacing="5" border="1" width="80%">
                      <tr>
                        <td width="50%">CPI(Course work)</td>
                        <td width="50%"><%=cpi%></td>
                   </tr>


                        <td>Synopsis Submitted :
                          <input type="radio" name="isThesisSubmitted" value="1" <% if(isThesisSubmitted.equals("1")) out.println("checked"); %>/>
Yes
<input type="radio" name="isThesisSubmitted" value="0" <% if(isThesisSubmitted.equals("0")) out.println("checked"); %>/>
No<br></td>
          ...
          <tr>
          <td align="center">
          	<p><strong>Fields marked with * are compulsory.<!--REGISTRATION IS CLOSED.--> </strong>
          	<br><strong>Submit the entries according to your certificates, make sure you have sufficient evidences to defend these details during verification.<br>You cannot modify the form if you check the below checkbox and press submit.<br>Uncheck it and press submit for temporary submission.</strong></p></td>
          </tr>
          <tr>
            <td align="center">
...
var sprytextfield13 = new Spry.Widget.ValidationTextField("sprytextfield13", "real", {hint:"Upto 2 decimals", validateOn:["blur"], minValue:1, maxValue:100});
var sprytextfield14 = new Spry.Widget.ValidationTextField("sprytextfield14", "none", {validateOn:["blur"], hint:"YYYY", minChars:4, maxChars:4});
var sprytextfield15 = new Spry.Widget.ValidationTextField("sprytextfield15", "none", {validateOn:["blur"], hint:"ex: ICSE"});
var sprytextfield16 = new Spry.Widget.ValidationTextField("sprytextfield16", "none", {validateOn:["blur"], hint:"ex: Hindi"});
var sprytextfield17 = new Spry.Widget.ValidationTextField("sprytextfield17", "none", {validateOn:["blur"], hint:"ex: First"});
var sprytextfield18 = new Spry.Widget.ValidationTextField("sprytextfield18", "real", {validateOn:["blur"], minValue:1, maxValue:100});
var sprytextfield19 = new Spry.Widget.ValidationTextField("sprytextfield19", "none", {validateOn:["blur"], hint:"YYYY", minChars:4, maxChars:4});
var sprytextfield20 = new Spry.Widget.ValidationTextField("sprytextfield20", "none", {validateOn:["blur"]});
var sprytextfield21 = new Spry.Widget.ValidationTextField("sprytextfield21", "none", {validateOn:["blur"], hint:"ex:University name"});
var sprytextfield22 = new Spry.Widget.ValidationTextField("sprytextfield22", "none", {validateOn:["blur"], hint:"ex : Hindi/English"});
var sprytextfield23 = new Spry.Widget.ValidationTextField("sprytextfield23", "none", {validateOn:["blur"], hint:"ex: Second"});
