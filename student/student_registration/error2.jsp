...
<div id="pagecell1"> 
  ...
  <div id="pageNav">
    ...
    <%--  <a href="../placement_status/status.jsp">Placement Status</a><a href="../ppts/get_pdf.jsp">Organization PPT's</a> --%>
      ...
      <a href="../../logout.jsp">LOGOUT</a><img name="bot" src="../images/bot.gif" width="181" height="243" border="0" id="bot" alt="" /></div>
    <div class="relatedLinks"></div>
  </div>
  <div id="content"> 
    <div class="feature">
      <p align="center"><strong>Error!!!</strong></p>
      <p align="center"><strong>Please Contact Placement Cell and verify your student data.</strong></p>    
    </div> 
  </div>
