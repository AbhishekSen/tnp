	     ...
	     if ( (todo != null) && (todo.equalsIgnoreCase("upload")) )
	     {
                ...
                if ( (files != null) && (!files.isEmpty()) )
                {
                    ...
                    // Uses the bean now to store specified by jsp:setProperty at the top.
						...
						if(conttype.equals(req1)&&file_size<=204800)
						{
...
<img name="bot" src="../images/bot.gif" width="181" height="243" border="0" id="bot" alt="" /></div>
  ...
  <div id="content"> 
    <div class="feature">
<form method="post" action="upload1.jsp" name="upform" enctype="multipart/form-data">
    ...
    <tr>
      <td align="left">
		<p>
		  ...
		  <input type="submit" name="Submit" value="Upload CV2" onClick="return getstat();">
		  <input type="reset" name="Reset" value="Cancel"> 
		  </p>
		<p>To upload CV1 go <a href="upload.jsp">here</a>. </p>
	   <td>
		<%/*<p>Your present uploaded CV1 is <a href="down_cv.jsp?cv_id=0">here</a>.</p>
		<p>Your present uploaded CV2 is <a href="down_cv.jsp?cv_id=1">here</a>.</p>*/%>
	</td>
    </tr>
  </table>
  <p><br>
