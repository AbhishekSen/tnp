...
<%
      ...
      String str_path=apath+"placement_new/image_uploads/";
                    ...
                    // Uses the bean now to store specified by jsp:setProperty at the top.
					 if(id==1)
						...
						if(id==1 && file_size<=51200)
						{
							...
							String f_name=apath+"placement_new/image_uploads/"+roll_no+"_img.jpeg";
						...
						if(id==2 && file_size<=51200)
						{
						   //String f_name=gpath+"../../../images/"+roll_no+"_sign.jpeg";
							String f_name=apath+"placement_new/image_uploads/"+roll_no+"_sign.jpeg";
